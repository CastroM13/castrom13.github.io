...
- **Android splash screen:** When launching it from the home screen on Android, 5E now gets a fancy splash screen.
- **Better standalone mode:** After adding 5E to your device's home screen (or installing it in your browser as an app), it now behaves like its own app, including showing up in your app switcher as "5E." It did this before, but now it should behave a little nicer. Depending on your platform, it might even show a back button now.
